...
// import Docx from '../assets/img/snapshots/docx.png';
...
export const projectDatas: ProjectDatas = {
	React: [
		...
		},
		{
			...
			src: LittleLemon,
			description:
				"Front-End Developer Capstone project for META.",
		...
		},
		{
			...
			src: Erika,
			description:
				"RISTEK Sistech Mentorship Program Software Engineering division Final Project.",
	...
	Svelte: [
		...
		},
		{
			...
			src: Namecard,
			description:
				"To access my online namecard.",
			href: 'https://github.com/sarahT04/reports',
			technologyUsed: 'Tailwind, etc.'
		},
		{
			none: true, title: 'NoneSvelte1'
		},
		{
			none: true, title: 'NoneSvelte2'
		},
	],
	Python: [
		{
		...
		},
		{
			...
			src: TreasureHunt,
			description:
				"Ever want to try to play a treasure hunt game with a CLI?",
